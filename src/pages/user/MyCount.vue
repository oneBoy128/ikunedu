...
<template>
    <div id="mycount">
                ...
                <el-col :span="24">
                    <el-menu class="el-menu-vertical-demo" @select="handleOpen" replace :router="true"
                        ...
                        <el-submenu index="3" v-show="isStudent">
                            ...
                            <el-menu-item-group>
                                <el-menu-item index="/mycount/mylesson">我学习的课程</el-menu-item>
                            </el-menu-item-group>
                        </el-submenu>
                        <!--老师专用-->
                        <el-submenu index="3" v-show="isTeacher">
                            ...
                            <el-menu-item-group>
                                ...
                                <el-menu-item index="/mycount/mylesson">我学习的课程</el-menu-item>
                                <el-menu-item index="/mycount/cheackhomework">检查作业</el-menu-item>
                            </el-menu-item-group>
                        </el-submenu>
                        <!--管理员专用-->
                        <el-submenu index="3" v-show="isAdmin">
                            ...
                            <el-menu-item-group>
                                ...
                                <el-menu-item index="/mycount/adminrole">审核角色</el-menu-item>
                            </el-menu-item-group>
                        </el-submenu>
                    </el-menu>
                </el-col>
        ...
        <!--这是一个修改头像的框框-->
        <el-dialog :visible.sync="dialogVisible" width="40%" :destroy-on-close="destroy">
            <MyTest></MyTest>
        </el-dialog>
