        ...
        <div class="form-box">
            ...
            <div class="login-box">
                ...
                <div class="btn-box">
                    ...
                    <div>
                        <el-link class="links" href="http://localhost:8081/#/yemian" type="primary"
                            style="font-size: 12px;">返回主页</el-link>
                        <el-link class="links" href="http://localhost:8081/#/forget" type="primary"
                            style="font-size: 12px;">忘记密码</el-link>
                    </div>
                </div>
            </div>
        ...
        onload() {
            ...
            axios({
                ...
                if (resp.data.code == 2002) {
                    console.log('login组件里的',resp)
                    localStorage.setItem('isOnline', true)
                    this.$store.state.isOnline = true
                    this.$store.dispatch('letLoading', resp.data.data.user)
                    this.$router.push('/')
                }
