            ...
            <div id="imgconter">
                <div style="margin-bottom: 20px;">
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                        <el-breadcrumb-item :to="{ path: '/mycount/myinform' }">个人中心</el-breadcrumb-item>
                        <el-breadcrumb-item>修改当前课程</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div id="imgConter">
                    <!-- 显示上传的图片 -->
...
export default {
    ...
    methods: {
        ...
        submitLesson() {
            ...
            axios({
                method: 'post',
                url: 'http://localhost:8081/course/updateCourse',
                headers: {
                    'Content-Type': 'application/json;charset=UTF-8'
                },
